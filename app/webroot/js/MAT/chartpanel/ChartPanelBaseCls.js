...
/**
 * @class MAT.chartpanel.ChartPanelBaseCls
 * @extends Ext.Panel
 ...
 **/
MAT.chartpanel.ChartPanelBaseCls = Ext.extend(Ext.Panel , {
	frame       : false,
	layout      : 'fit',
	//private
	chartExtraStyles : {
		...
		legend : {
			...
			padding : 5,
			spacing : 2,
			font    : { color : 0x000000,  family : "Verdana", size : 10, bold : 1 },
	...
	initComponent : function() {
		...
		MAT.chartpanel.ChartPanelBaseCls.superclass.initComponent.call(this);
		/**
		* @event itemclick
	...
	*/
	tipRenderer :  function(chart, record, index, series){
		...
		var itemInfo  =  'Items ' + series.displayName + ': '+ record.get(series.yField);
		return yearInfo + '\n' + itemInfo ;
	}
});

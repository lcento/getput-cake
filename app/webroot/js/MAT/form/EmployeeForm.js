 ...
 * @xtype employeeform
 **/
MAT.form.EmployeeForm = Ext.extend(MAT.form.FormPanelBaseCls, {
	border        : true,
	autoScroll    : true,
	...
	initComponent : function() {
		...
		MAT.form.EmployeeForm.superclass.initComponent.call(this);
	...
	buildFormItems : function() {
		var 	topContainer			= this.buildTopContainer(),
			...
			permitAddonContainer		= this.buildAddonContainer();
					...
					items  : {
						...
						store          : {
							...
							proxy    : new Ext.data.HttpProxy({
								url: '/getput-cake/admins/jsonGetLevelUser'
							}),
							fields   : [ 
			...
			items       : [
				{
					items  : {
						...
						store          : {
							...
							proxy    : new Ext.data.HttpProxy({
								url: '/getput-cake/admins/jsonGetTypeUser'
							}),
							fields   : [ 
			...
			items       : [
				{
					items  : {
						...
						store          : {
							...
							proxy    : new Ext.data.HttpProxy({
								url: '/getput-cake/admins/jsonGetAccessUser'
							}),
							fields   : [ 
			...
			items       : [
				{
					items  : {
						...
						store          : {
							...
							proxy    : new Ext.data.HttpProxy({
								url: '/getput-cake/admins/jsonGetAccessRealnameUser'
							}),
							fields   : [ 
			...
			items       : [
				{
					items  : {
						...
						store          : {
							...
							proxy    : new Ext.data.HttpProxy({
								url: '/getput-cake/admins/jsonGetAgencyGroup'
							}),
							fields   : [ 
...
Ext.reg('employeeform', MAT.form.EmployeeForm);

						...
						<td>
							<table width="310px" height="170px" class="flash_form1" align="center" border="0">
								...
								<tr height="10px" align="left" valign="top">
									<td align="center" valign="middle" class="text_message2"><?php echo $message; ?></td>
								</tr>
								<tr height="10px" align="left" valign="top">
									<td align="center" valign="middle">
										<?php echo $html->link('Indietro', array('controller' => 'uploads', 'action' => 'articles'), array('class' => 'link_message1'));?>
									</td>
								</tr>
							</table>
						</td>
